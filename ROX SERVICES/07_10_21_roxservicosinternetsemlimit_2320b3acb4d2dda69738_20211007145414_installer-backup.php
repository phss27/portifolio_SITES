...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '07_10_21_roxservicosinternetsemlimit_2320b3acb4d2dda69738_20211007145414_archive.zip';
	const ARCHIVE_SIZE		 = '90170142';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2320b3a-07145414';
    const SECONDARY_PACKAGE_HASH = 'a4e74f2-07145414';
	const VERSION			 = '1.4.3';
