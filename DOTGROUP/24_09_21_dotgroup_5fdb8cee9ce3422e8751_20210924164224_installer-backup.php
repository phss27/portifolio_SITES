...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '24_09_21_dotgroup_5fdb8cee9ce3422e8751_20210924164224_archive.zip';
	const ARCHIVE_SIZE		 = '424167516';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5fdb8ce-24164224';
    const SECONDARY_PACKAGE_HASH = 'd5ee893-24164224';
	const VERSION			 = '1.4.3';
